...
@mark.parametrize("room_id, date_from, date_to, status_code", [
...
@mark.parametrize("room_id, date_from, date_to, booking_count", [
...
async def test_post_and_get_users_bookings(
    ...
    second_response = await auth_ac.get(
        "/bookings/me",
        params={
            "user_id": user_id
        }
